-- CITYBRIDGEBANK Database Schema
...
VALUES ('admin', 'admin@citybridgebank.com', '$2y$10$placeholder_hash_to_be_updated', 'System Administrator', 'super_admin');
...
VALUES ('testuser', 'test@citybridgebank.com', '$2y$10$placeholder_hash_to_be_updated', 'Test User', '+1234567890', '123 Main Street, City', '1990-01-01', 'CBB100000000001', 'verified');