...
?>
<section class="hero"><div class="container"><h1>Withdraw Funds</h1><p>Withdrawal requests require admin approval.</p></div></section>
...
<div class="form-group"><label>Recipient Bank</label><input class="form-control" type="text" name="recipient_bank" required></div>
...
document.getElementById('openPinModalBtn').addEventListener('click', function(){
  if(!document.getElementById('withdrawForm').reportValidity()) return;
  stageIndex = 0;
